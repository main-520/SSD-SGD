...
DMLC_REGISTER_PARAMETER(ADCParam); // define this to implement ADCASGD 9.2
DMLC_REGISTER_PARAMETER(MSParam);
DMLC_REGISTER_PARAMETER(DCParam);

//=============== GLU Register 5.2 =================


//================= DCASGD Register 9.3 ======================
NNVM_REGISTER_OP(dc_sgd_update)
.describe(R"code(This is used for the local update of the OD-SGD algorithm to
cut down the compuatational overhead.
)code" ADD_FILELINE)
.set_attr_parser(ParamParser<DCParam>)
.set_num_inputs(3)
.set_num_outputs(1)
...
.set_attr<FCompute>("FCompute<cpu>", DCUpdate<cpu>)
.add_argument("weight", "NDArray-or-Symbol", "Weight")
.add_argument("grad", "NDArray-or-Symbol", "Gradient")
.add_argument("previous", "NDArray-or-Symbol", "Previous")
.add_arguments(DCParam::__FIELDS__());


//================= MeanSquare Calculation Register 9.3 ======================
NNVM_REGISTER_OP(ms_update)
.describe(R"code(This is used for the local update of the OD-SGD algorithm to
cut down the compuatational overhead.
)code" ADD_FILELINE)
.set_attr_parser(ParamParser<MSParam>)
.set_num_inputs(2)
.set_num_outputs(1)
...
.set_attr<FCompute>("FCompute<cpu>", MSUpdate<cpu>)
.add_argument("meansquare", "NDArray-or-Symbol", "Meansquare")
.add_argument("grad", "NDArray-or-Symbol", "Gradient")
.add_arguments(MSParam::__FIELDS__());

//================= CADCASGD Register 9.3 ======================
NNVM_REGISTER_OP(adc_sgd_update)
.describe(R"code(This is used for the local update of the OD-SGD algorithm to
cut down the compuatational overhead.
)code" ADD_FILELINE)
.set_attr_parser(ParamParser<ADCParam>)
.set_num_inputs(4)
.set_num_outputs(1)
...
.set_attr<FCompute>("FCompute<cpu>", ADCUpdate<cpu>)
.add_argument("weight", "NDArray-or-Symbol", "Weight")
.add_argument("grad", "NDArray-or-Symbol", "Gradient")
.add_argument("previous", "NDArray-or-Symbol", "Previous")
.add_argument("meansquare", "NDArray-or-Symbol", "Meansquare")
.add_arguments(ADCParam::__FIELDS__());

// add this to update the meansquare locally 9.3
