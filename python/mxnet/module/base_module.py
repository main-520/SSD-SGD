...
class BaseModule(object):
    ...
    def __init__(self, logger=logging):
        ...
        # add this: 1.4: used for warmup phase;
        self.count_pull = 0
    ...
    # add this 1.3: optimizer_local, optimizer_local_params
    def fit(self, train_data, eval_data=None, eval_metric='acc',
            epoch_end_callback=None, batch_end_callback=None, kvstore='local',
            optimizer='sgd', optimizer_params=(('learning_rate', 0.01),),
            optimizer_local='sgd', optimizer_local_params = (('learning_rate', 0.01),),
        ...
        # edit this: 1.3
        self.init_optimizer(kvstore=kvstore, optimizer=optimizer, optimizer_local = optimizer_local,
