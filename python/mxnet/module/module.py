...
class Module(BaseModule):
    ...
    # add this 1.4: This funciton does not really make sense.
    def update_local(self):
        # edit this function to update the local weights with the calculated gradients 4.23
